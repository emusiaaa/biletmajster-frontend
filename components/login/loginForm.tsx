...
export default function SignIn() {
    ...
    const submitFunction = async (e: SyntheticEvent) => {
        ...
        setLoading(true);
        const response = await apiClient.organizer.loginOrganizer({ headers: input }); // we have to do that, since *somebody* thought it would be good idea to send data in headers
        setLoading(false);
        if (response.ok) {
