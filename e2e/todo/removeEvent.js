...
async function test_case() {
  ...
  // title
  await driver.findElement(By.xpath("//*[@id=':r2:']")).sendKeys("SeleniumCreateDeleteEvent2");
  // max places
  ...
  await driver.wait(until.elementIsVisible(await driver.findElement(
    By.xpath('//div[contains(@class, "MuiCard-root") and contains(., "SeleniumCreateDeleteEvent2")]//button[@data-testid="delete-event-button"]')))).click();
  await forMs(4000);
