...
async function test_case() {
  ...
  // title
  await driver.findElement(By.xpath("//*[@id=':r2:']")).sendKeys("BSeleniumTestEvent1212312334");
  // max places
  ...
  // click on OK button with enter - chyba niepotrzebne
  // await driver.actions().sendKeys(Key.ENTER).perform();
  ...
  await driver.findElement(By.xpath("//*[@data-testid='delete-event-button' and ancestor[normalize-space()='BSeleniumTestEvent1212312334']")).click();
